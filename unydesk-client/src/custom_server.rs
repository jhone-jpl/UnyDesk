...
fn get_custom_server_from_config_string(s: &str) -> ResultType<CustomServer> {
    ...
    // UnySystems Ed25519 verify key for filename-embedded license
    // (see /keys/custom_server_signing.key.json)
    const PK: &[u8; 32] = &[
        122, 241, 78, 170, 239, 72, 21, 237, 77, 234, 86, 114, 226, 78, 47, 243, 221, 4, 214, 159,
        149, 64, 167, 115, 205, 192, 67, 196, 162, 137, 101, 89,
    ];
